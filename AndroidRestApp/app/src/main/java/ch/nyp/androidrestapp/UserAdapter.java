...
public class UserAdapter extends ArrayAdapter<User> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mLayoutInflater.inflate(R.layout.layout_listview_user, null);

			viewHolder = new ViewHolder();
			viewHolder.itemNameTextView = convertView.findViewById(R.id.textview_listview_user);
